...
export default class PortfolioForm extends Component {
    constructor (props) {
        ...
        this.state = {
            ...
            logo: "",
            editMode: false,
            apiUrl: "https://jovanespinosa.devcamp.space/portfolio/portfolio_items/",
            apiAction: "post"
        }
    ...
    componentDidUpdate() {
        if(Object.keys(this.props.portfolioToEdit).length > 0) {
            ...
            this.setState({
                ...
                category: category || "Enterprice",
                position: position || "",
                url: url || "",
                editMode: true,
                apiUrl: `https://jovanespinosa.devcamp.space/portfolio/portfolio_items/${id}`,
                apiAction: "patch",
